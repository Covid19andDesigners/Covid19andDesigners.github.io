<!DOCTYPE html>
<html>
<title>Masaba Gupta - Covid-19 and Designers</title>
<meta charset="UTF-8">
  ...
  <div class="w3-row w3-padding w3-border">
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <br></br>
          <center><img src="img/masabaGuptaMask.jpg" alt="Masaba Gupta Mask" width="70%"></center>
          <p>The popular Indian designer is creating masks with her inimitable touch, featuring happy prints and bright colours that are a signature of the brand. Available for sale via her site, for every piece sold, Gupta is donating one to someone in need. Adding a fun element, you can even virtually ‘try on’ these masks via a filter on the brand’s Instagram page.</p>
          <a href="https://www.houseofmasaba.com/" target="_blank">Masaba Gupta's Official Site</a>
          <p class="w3-clear"></p>
         </div>
       </div> 
      </div> 
